 ...
 *
 *
 * 6x8 horizontal lsb_1 font from LSB_1 from Benedikt K.
...
const struct character g_Font[256] PROGMEM =
{
    ...
    {0x78,0x40,0x20,0x10,0x08,0x08,0x78,0x00},  // 0x5A
    ...
    {0x00,0x00,0x70,0x80,0xF0,0x88,0xF0,0x00},  // 0x61
    ...
    {0x00,0x00,0x48,0x48,0x48,0x68,0x50,0x00},  // 0x75
    ...
    {0x00,0x00,0x78,0x40,0x30,0x08,0x78,0x00},  // 0x7A
    ...
    {0x60,0x00,0x70,0x20,0x20,0x20,0x70,0x00},  // 0xD6
    ...
    {0x50,0x28,0x00,0x30,0x48,0x48,0x30,0x00},  // 0xE4
    ...
    {0x38,0x10,0x30,0x18,0x00,0x00,0x00,0x00},  // 0xFC
